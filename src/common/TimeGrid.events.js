...
TimeGrid.mixin({
	...
	//==============================================
	//	These functions used to be outside of TimeGrid, Os moved them in, to be able to extend them under the MultiTimeGrid
	//==============================================
	...
	computeSlotSegCoords:function(seg, seriesBackwardPressure, seriesBackwardCoord) {
		...
		if (seg.forwardCoord === undefined) { // not already computed
			...
			if (!forwardSegs.length) {
				...
				forwardSegs.sort(this.compareForwardSlotSegs);
